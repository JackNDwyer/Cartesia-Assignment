...
(I will include detailed first impressions/thoughts below the 3 parts).
...
I also found what appears to be a bug with the mp3 Bytes call. Depending on Sample Rate, the audio playback speed is altered.

16k is fast and high pitched, 48k is slow and low pitched. The only one that worked is 44.1k.
...
<audio controls>
  <source src="./Snippets/16k.mp3" type="audio/mp3">
...
<audio controls>
  <source src="./Snippets/48k.mp3" type="audio/mp3">
  Your browser does not support the audio element.
</audio>
...
<audio controls>
  <source src="./Snippets/441k.mp3" type="audio/mp3">
  Your browser does not support the audio element.
</audio>
