...
I also found what appears to be a bug with the mp3 `Bytes` call. WAVs produced expecte behavior, but depending on Sample Rate, the mp3 audio playback speed is altered.
...
[example-prompts.mp4](./Public/example-prompts.mp4)
